...
class About extends CI_Controller {
	...
	public function getfielddata(){
			...
			if(isset($_POST['oldImage1'])){
				if(is_file('assets/upload/pages/'.$_POST['oldImage1'])){
				unlink('assets/upload/pages/'.$_POST['oldImage1']);
				}
			}
			
			$fields['Image'] = $this->do_upload($config, 'Image1');	
			...
			if(isset($_POST['oldImage2'])){
				if(is_file('assets/upload/pages/'.$_POST['oldImage2'])){
				unlink('assets/upload/pages/'.$_POST['oldImage2']);
				}
			}
