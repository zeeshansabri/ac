...
class ShortServices extends CI_Controller {
	...
	public function getvalues($Get){
		...
		if($Get == 'table'){
			...
			$return =  array('Name', 'Description', 'Icon', 'SortOrder');
		} else if($Get == 'TableHeading'){
			$return =  array('Heading', 'ShortDescription', 'Icon', 'SortOrder');
		}
		return $return;
	}
	...
	public function getfielddata(){
		    ...
		    $KeyPoints		 =	$this->input->post('KeyPoints');
			...
			if(isset($_POST['oldImage'])){
				if(is_file('assets/upload/shortservices/'.$_POST['oldImage'])){
				unlink('assets/upload/shortservices/'.$_POST['oldImage']);
				}
			}
