...
class image_cat extends CI_Controller {
	...
	function __construct() {
		...
		public function getvalues($Get){
			...
			if($Get == 'table'){
				...
				$return	=	'assets/upload/image_cat/';
		...
		public function getfielddata($ID = NULL){
				...
				$Image1	=	$this->uploadImage('ProductCategoryImage', 'ProductCategoryOldImage', $loc);
				if($Image1 != ''){
					$fields['ImageName'] =	$Image1;
				}
		...
		public function view_all(){
			...
			$this->load->view('mmsadmin/'.$folder.'/image_cat',$data);
