...
class References extends CI_Controller {
	...
	public function getvalues($Get){
		...
		if($Get == 'table'){
			...
			$return =  array('Reference Name', 'Email', 'Website', 'Address', 'Reference From');
		} else if($Get == 'TableHeadings'){
			$return =  array('Company', 'EmailAddress', 'Website', 'Address', 'CompanyName');
		}		
	...
	public function view_all(){
		...
		$CustomQ = 'SELECT a.*, b.CompanyName FROM ' . $table . ' AS a LEFT JOIN users AS b ON a.UserID = b.ID';
		$CustomQ .= ' Order By CreateDate DESC';
		$result = $this->db->query($CustomQ);
		$data['data_row'] = $result->result();
		/* ALL SLIDER DATA */
		...
		public function edit($ID){
			...
			$table =  $this->getvalues('table');
			$CustomQ = 'SELECT a.*, b.CompanyName FROM ' . $table . ' AS a LEFT JOIN users AS b ON a.UserID = b.ID WHERE a.ID = ' . $ID;
			$result = $this->db->query($CustomQ);
	  ...
	  public function delete() {
	   ...
	   public function do_edit() {
					...
					if($_POST['save'] == 'email'){
						...
						$body	=	$this->input->post('EmailContent');
						$email	=	$this->input->post('EmailAddress');
						
						$this->mailer->sendreferences($email, $body);
						
						$Date		=	date("d/m/Y h:i");
						$fields['EmailStatus']	=	'Email Sent on ' . $Date;
					...
					if($_POST['save'] == 'save' || $_POST['save'] == 'email'){
