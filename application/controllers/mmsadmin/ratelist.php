...
class RateList extends CI_Controller {
	...
	public function view_all(){
		...
		public function edit($ID){
			...
			$RQ		 = 	' SELECT a.*, b.Country, c.Network FROM ratelist AS a LEFT JOIN country AS b ON a.CountryID = b.ID LEFT JOIN network AS c ON a.NetworkID = c.ID WHERE a.ID = ' . $ID;
			$RQR	 =	$this->db->query($RQ);
			$result  = 	$RQR->result();
			$data['Info'] = $result;
